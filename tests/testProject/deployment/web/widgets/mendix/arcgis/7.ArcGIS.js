...
See https://js.arcgis.com/4.20/esri/copyright.txt for details.
*/
const u=[0,0];function h(s,t){if(!t)return null;if("x"in t){const n={x:0,y:0};return[n.x,n.y]=s(t.x,t.y,u),null!=t.z&&(n.z=t.z),null!=t.m&&(n.m=t.m),n}if("xmin"in t){const n={xmin:0,ymin:0,xmax:0,ymax:0};return[n.xmin,n.ymin]=s(t.xmin,t.ymin,u),[n.xmax,n.ymax]=s(t.xmax,t.ymax,u),t.hasZ&&(n.zmin=t.zmin,n.zmax=t.zmax,n.hasZ=!0),t.hasM&&(n.mmin=t.mmin,n.mmax=t.mmax,n.hasM=!0),n}return"rings"in t?{rings:c(t.rings,s),hasM:t.hasM,hasZ:t.hasZ}:"paths"in t?{paths:c(t.paths,s),hasM:t.hasM,hasZ:t.hasZ}:"points"in t?{points:l(t.points,s),hasM:t.hasM,hasZ:t.hasZ}:void 0}function c(s,t){const n=[];for(const e of s)n.push(l(e,t));return n}function l(s,t){const n=[];for(const e of s){const s=t(e[0],e[1],[0,0]);n.push(s),e.length>2&&s.push(e[2]),e.length>3&&s.push(e[3])}return n}async function p(t,n){if(!n)return;const e=Array.isArray(t)?t.map((s=>{var t;return null==(t=s.geometry)?void 0:t.spatialReference})):[t];await Object(_geometry_projection_js__WEBPACK_IMPORTED_MODULE_0__["initializeProjection"])(e.map((s=>({source:s,dest:n}))))}const f=h.bind(null,_geometry_support_webMercatorUtils_js__WEBPACK_IMPORTED_MODULE_3__["lngLatToXY"]),x=h.bind(null,_geometry_support_webMercatorUtils_js__WEBPACK_IMPORTED_MODULE_3__["xyToLngLat"]);function y(s,o,a){return s?(a||(a=o,o=s.spatialReference),Object(_geometry_support_spatialReferenceUtils_js__WEBPACK_IMPORTED_MODULE_2__["isValid"])(o)&&Object(_geometry_support_spatialReferenceUtils_js__WEBPACK_IMPORTED_MODULE_2__["isValid"])(a)&&!Object(_geometry_support_spatialReferenceUtils_js__WEBPACK_IMPORTED_MODULE_2__["equals"])(o,a)?Object(_geometry_support_webMercatorUtils_js__WEBPACK_IMPORTED_MODULE_3__["canProject"])(o,a)?Object(_geometry_support_spatialReferenceUtils_js__WEBPACK_IMPORTED_MODULE_2__["isWebMercator"])(a)?f(s):x(s):Object(_geometry_projection_js__WEBPACK_IMPORTED_MODULE_0__["projectMany"])(_geometry_geometryAdapters_json_js__WEBPACK_IMPORTED_MODULE_1__["jsonAdapter"],[s],o,a,null)[0]:s):s}class g{constructor(){this._jobs=[],this._timer=null,this._process=this._process.bind(this)}async push(s,t,n){if(!s||!s.length||!t||!n||Object(_geometry_support_spatialReferenceUtils_js__WEBPACK_IMPORTED_MODULE_2__["equals"])(t,n))return s;const e={geometries:s,inSpatialReference:t,outSpatialReference:n,resolve:null};return this._jobs.push(e),new Promise((s=>{e.resolve=s,null===this._timer&&(this._timer=setTimeout(this._process,10))}))}_process(){this._timer=null;const s=this._jobs.shift();if(!s)return;const{geometries:e,inSpatialReference:r,outSpatialReference:o,resolve:a}=s;Object(_geometry_support_webMercatorUtils_js__WEBPACK_IMPORTED_MODULE_3__["canProject"])(r,o)?Object(_geometry_support_spatialReferenceUtils_js__WEBPACK_IMPORTED_MODULE_2__["isWebMercator"])(o)?a(e.map(f)):a(e.map(x)):a(Object(_geometry_projection_js__WEBPACK_IMPORTED_MODULE_0__["projectMany"])(_geometry_geometryAdapters_json_js__WEBPACK_IMPORTED_MODULE_1__["jsonAdapter"],e,r,o,null)),this._jobs.length>0&&(this._timer=setTimeout(this._process,10))}}const _=new g;function j(s,t,n){return _.push(s,t,n)}


/***/ })

}]);
//# sourceMappingURL=7.ArcGIS.js.map