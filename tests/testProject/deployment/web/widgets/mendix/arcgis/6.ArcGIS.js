...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CIMSymbolDrawHelper", function() { return p; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "C_DEG_TO_RAD", function() { return f; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CanvasDrawHelper", function() { return y; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EnvDrawHelper", function() { return _; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Transformation", function() { return u; });
...
See https://js.arcgis.com/4.20/esri/copyright.txt for details.
*/
class u{static local(){return null===u.instance&&(u.instance=new u),u.instance}execute(t,n,e){return new c(t,n,e)}}u.instance=null;class c{constructor(t,n,e){this._inputGeometries=t,this._rotateAngle=void 0!==n.angle?-n.angle*Math.PI/180:0}next(){let u=this._inputGeometries.next();for(;u;){if(0===this._rotateAngle)return u;const c=Object(_geometry_support_aaBoundingRect_js__WEBPACK_IMPORTED_MODULE_1__["create"])();Object(_geometry_support_boundsUtils_js__WEBPACK_IMPORTED_MODULE_2__["getBoundsXY"])(c,u);const l=(c[2]+c[0])/2,m=(c[3]+c[1])/2;if(Object(_geometry_support_jsonUtils_js__WEBPACK_IMPORTED_MODULE_3__["isExtent"])(u)){const t={rings:[[[u.xmin,u.ymin],[u.xmin,u.ymax],[u.xmax,u.ymax],[u.xmax,u.ymin],[u.xmin,u.ymin]]]};return this._rotateMultipath(t.rings,l,m),t}if(Object(_geometry_support_jsonUtils_js__WEBPACK_IMPORTED_MODULE_3__["isPolygon"])(u)){const n=Object(_core_lang_js__WEBPACK_IMPORTED_MODULE_0__["clone"])(u);return this._rotateMultipath(n.rings,l,m),n}if(Object(_geometry_support_jsonUtils_js__WEBPACK_IMPORTED_MODULE_3__["isPolyline"])(u)){const n=Object(_core_lang_js__WEBPACK_IMPORTED_MODULE_0__["clone"])(u);return this._rotateMultipath(n.paths,l,m),n}if(Object(_geometry_support_jsonUtils_js__WEBPACK_IMPORTED_MODULE_3__["isMultipoint"])(u)){const n=Object(_core_lang_js__WEBPACK_IMPORTED_MODULE_0__["clone"])(u);return this._rotatePath(n.points,l,m),n}if(Object(_geometry_support_jsonUtils_js__WEBPACK_IMPORTED_MODULE_3__["isPoint"])(u))return u;u=this._inputGeometries.next()}return null}_rotateMultipath(t,n,e){if(t)for(const r of t)this._rotatePath(r,n,e)}_rotatePath(t,n,e){if(t){const r=Math.cos(this._rotateAngle),i=Math.sin(this._rotateAngle);for(const o of t){const t=o[0]-n,s=o[1]-e;o[0]=n+t*r-s*i,o[1]=e+t*i+s*r}}}}
...
See https://js.arcgis.com/4.20/esri/copyright.txt for details.
*/
class c{static local(){return null===c.instance&&(c.instance=new c),c.instance}execute(t,s,i){return new l(t,s,i)}}c.instance=null;class l{constructor(t,s,i){this._inputGeometries=t,this._xFactor=void 0!==s.xScaleFactor?s.xScaleFactor:1.15,this._yFactor=void 0!==s.yScaleFactor?s.yScaleFactor:1.15}next(){let c=this._inputGeometries.next();for(;c;){if(1===this._xFactor&&1===this._yFactor)return c;const l=Object(_geometry_support_aaBoundingRect_js__WEBPACK_IMPORTED_MODULE_1__["create"])();Object(_geometry_support_boundsUtils_js__WEBPACK_IMPORTED_MODULE_2__["getBoundsXY"])(l,c);const u=(l[2]+l[0])/2,m=(l[3]+l[1])/2;if(Object(_geometry_support_jsonUtils_js__WEBPACK_IMPORTED_MODULE_3__["isExtent"])(c)){const t={rings:[[[c.xmin,c.ymin],[c.xmin,c.ymax],[c.xmax,c.ymax],[c.xmax,c.ymin],[c.xmin,c.ymin]]]};return this._scaleMultipath(t.rings,u,m),t}if(Object(_geometry_support_jsonUtils_js__WEBPACK_IMPORTED_MODULE_3__["isPolygon"])(c)){const s=Object(_core_lang_js__WEBPACK_IMPORTED_MODULE_0__["clone"])(c);return this._scaleMultipath(s.rings,u,m),s}if(Object(_geometry_support_jsonUtils_js__WEBPACK_IMPORTED_MODULE_3__["isPolyline"])(c)){const s=Object(_core_lang_js__WEBPACK_IMPORTED_MODULE_0__["clone"])(c);return this._scaleMultipath(s.paths,u,m),s}if(Object(_geometry_support_jsonUtils_js__WEBPACK_IMPORTED_MODULE_3__["isMultipoint"])(c)){const s=Object(_core_lang_js__WEBPACK_IMPORTED_MODULE_0__["clone"])(c);return this._scalePath(s.points,u,m),s}if(Object(_geometry_support_jsonUtils_js__WEBPACK_IMPORTED_MODULE_3__["isPoint"])(c))return c;c=this._inputGeometries.next()}return null}_scaleMultipath(t,s,i){if(t)for(const r of t)this._scalePath(r,s,i)}_scalePath(t,s,i){if(t)for(const r of t){const t=(r[0]-s)*this._xFactor,n=(r[1]-i)*this._yFactor;r[0]=s+t,r[1]=i+n}}}
