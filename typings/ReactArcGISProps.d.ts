...
export type SketchPositionEnum = "bottomRight" | "bottomLeft" | "topRight" | "topLeft";
...
export interface ReactArcGISContainerProps {
    ...
    sketchPosition: SketchPositionEnum;
...
export interface ReactArcGISPreviewProps {
    ...
    intButtonActionTwo: {} | null;
    intButtonLabelTwo: string;
    intButtonClassTwo: string;
    intButtonIconTwo: { type: "glyph"; iconClass: string; } | { type: "image"; imageUrl: string; } | null;
    intButtonActionThree: {} | null;
    intButtonLabelThree: string;
    intButtonClassThree: string;
    intButtonIconThree: { type: "glyph"; iconClass: string; } | { type: "image"; imageUrl: string; } | null;
    cl_enabled: boolean;
    cl_symbolTextColor: string;
    ...
    userIdAttr: string;
    tokenAttr: string;
    expiryDateAttr: string;
    sketchEnabled: boolean;
    sketchReversalEnabled: boolean;
    sketchLayerID: string;
    sketchPosition: SketchPositionEnum;
    sketchPlaceholderIndex: number | null;
    sketchParentAssociationName: string;
    sketchParentObject: {} | null;
}
